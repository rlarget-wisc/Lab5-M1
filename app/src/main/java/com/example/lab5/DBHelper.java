...
public class DBHelper {
    ...
    public DBHelper(Context context) {
        this.sqLiteDatabase = context.openOrCreateDatabase("notes",Context.MODE_PRIVATE,null);
    }
    ...
    public void updateNotes(String title, String date, String username, String content) {
        createTable();
